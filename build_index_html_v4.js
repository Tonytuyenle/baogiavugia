...
<head>
  ...
  <title>Phần Mềm Quản Trị Giá Lock&King & Takin | Đối Chiếu Giá Nhập Cũ & Mới</title>
...
<body class="text-slate-800 antialiased min-h-screen flex flex-col">
    ...
    <aside class="w-64 bg-slate-900 text-slate-200 flex flex-col flex-shrink-0 z-20 shadow-xl select-none">
      ...
      <div class="p-4 border-b border-slate-800 flex items-center space-x-3 bg-slate-950/60">
        ...
        <div class="overflow-hidden">
          ...
          <p class="text-[9px] text-sky-400 font-bold tracking-wider uppercase">Quản Trị Giá Nhập & Bán</p>
        </div>
      </div>
      ...
      <nav class="flex-1 overflow-y-auto p-3 space-y-1 text-sm font-medium">
        ...
        <button onclick="navigateTab('prices')" id="nav-prices" class="nav-item w-full flex items-center space-x-3 px-3 py-2 rounded-lg text-slate-300 hover:bg-slate-800 hover:text-white transition">
          ...
          <span>So Sánh Giá Nhập & Bán</span>
        </button>
      ...
      <header class="bg-white border-b border-slate-200 px-6 py-3 flex items-center justify-between sticky top-0 z-10 shadow-sm">
        ...
        <div class="flex items-center space-x-3 ml-4">
          <a href="bang_gia_so_sanh_gia_nhap_cu_moi.xlsx" download class="hidden sm:flex items-center space-x-1.5 px-3 py-1.5 bg-emerald-50 text-emerald-700 border border-emerald-300 hover:bg-emerald-100 rounded-lg text-xs font-bold transition">
            ...
            <span>Tải Excel So Sánh Giá Nhập Cũ/Mới</span>
          </a>
      ...
      <div class="p-6 flex-1">
        ...
        <section id="tab-dashboard" class="tab-pane">
          <div class="flex flex-col md:flex-row md:items-center justify-between mb-6 gap-3">
            <div>
              <h2 class="text-xl font-black text-slate-900 flex items-center gap-2">
                Biến Động Giá Nhập Cũ vs Mới & Tầng Giá Bán
              </h2>
              <p class="text-xs text-slate-500 mt-0.5">Theo dõi lịch sử điều chỉnh giá vốn nhập xưởng và tác động tới lợi nhuận NPP</p>
            </div>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            ...
            <div class="bg-white p-4 rounded-xl border border-rose-200 bg-rose-50/20 shadow-sm flex items-center justify-between">
              <div>
                ...
                <span class="text-[10px] text-rose-800 font-bold flex items-center gap-1 mt-0.5">
                  <i data-lucide="trending-up" class="w-3 h-3"></i> Tăng do chi phí vật liệu/inox
                </span>
              </div>
            ...
            <div class="bg-white p-4 rounded-xl border border-slate-200 shadow-sm flex items-center justify-between">
              <div>
                <p class="text-[11px] font-bold text-slate-400 uppercase tracking-wider">Giá Nhập Giữ Nguyên</p>
                <h3 class="text-2xl font-black text-slate-700 mt-1">32 <span class="text-xs font-semibold text-slate-500">model</span></h3>
                <span class="text-[10px] text-slate-500 font-semibold flex items-center gap-1 mt-0.5">
                  <i data-lucide="check" class="w-3 h-3"></i> Ổn định đơn giá xưởng
                </span>
              </div>
          ...
          <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
            <div class="lg:col-span-2 bg-white p-5 rounded-xl border border-slate-200 shadow-sm">
              <div class="flex items-center justify-between mb-4">
                <div>
                  <h4 class="font-bold text-sm text-slate-900">Biểu Đồ So Sánh: Giá Nhập Cũ vs Mới vs Giá Bán</h4>
                  <p class="text-xs text-slate-500">Xem chi tiết các tầng giá của Model được chọn</p>
                </div>
            ...
            <div class="bg-white p-5 rounded-xl border border-slate-200 shadow-sm flex flex-col">
              <h4 class="font-bold text-sm text-slate-900 mb-1">Biến Động Giá Nhập Nhiều Nhất</h4>
              <p class="text-xs text-slate-500 mb-3">So sánh mức chênh lệch giữa Giá Nhập Cũ và Mới</p>
              
              <div id="topImportDiffList" class="flex-1 space-y-2 overflow-y-auto max-h-64"></div>
            </div>
          </div>
        </section>
        ...
        <section id="tab-products" class="tab-pane hidden">
          <div class="flex flex-col md:flex-row md:items-center justify-between mb-4 gap-3">
            <div>
              ...
              <p class="text-xs text-slate-500 mt-0.5">Bao gồm: Giá Nhập Cũ, Giá Nhập Mới, Thông Số Kỹ Thuật và các tầng giá NPP Online/Offline</p>
            </div>
            <div class="flex items-center gap-2">
              <a href="bang_gia_so_sanh_gia_nhap_cu_moi.xlsx" download class="px-3 py-1.5 bg-emerald-50 text-emerald-800 hover:bg-emerald-100 rounded-lg text-xs font-bold border border-emerald-300 flex items-center gap-1">
                <i data-lucide="file-spreadsheet" class="w-3.5 h-3.5"></i> Tải Excel Đối Chiếu
              </a>
            </div>
          </div>
              ...
              <table class="w-full text-xs text-left">
                <thead class="bg-slate-100 text-slate-700 font-bold border-b border-slate-200 uppercase text-[10px]">
                  <tr>
                    ...
                    <th class="py-3 px-3 col-import-price text-right text-slate-500">Giá Nhập Cũ</th>
                    <th class="py-3 px-3 col-import-price text-right text-rose-700">Giá Nhập Mới</th>
                    <th class="py-3 px-3 col-import-price text-center text-rose-800">Biến Động Vốn</th>
        ...
        <section id="tab-prices" class="tab-pane hidden">
          <div class="flex flex-col md:flex-row md:items-center justify-between mb-6 gap-3">
            <div>
              <h2 class="text-xl font-black text-slate-900">Bảng Quản Trị Đầy Đủ Các Tầng Giá</h2>
              <p class="text-xs text-slate-500 mt-0.5">So sánh Giá Nhập Mới, Giá Nhập Cũ, Giá NPP Online, Offline và Bán Lẻ</p>
            </div>
          </div>
            ...
            <table class="w-full text-xs text-left">
              <thead class="bg-slate-100 text-slate-700 font-bold border-b border-slate-200 uppercase text-[10px]">
                <tr>
                  ...
                  <th class="py-3 px-3 text-center">Chi Tiết</th>
                </tr>
              </thead>
        ...
        <section id="tab-quotations" class="tab-pane hidden">
          <div class="flex flex-col md:flex-row md:items-center justify-between mb-6 gap-3">
            <div>
              ...
              <p class="text-xs text-slate-500 mt-0.5">In ấn bản A4 hoặc xuất Excel</p>
            </div>
        ...
        <section id="tab-new-quote" class="tab-pane hidden">
          <div class="flex flex-col md:flex-row md:items-center justify-between mb-6 gap-3">
            <div>
              ...
              <p class="text-xs text-slate-500 mt-0.5">Lựa chọn áp dụng Giá NPP Offline, Online hoặc Giá Facebook</p>
            </div>
        ...
        <section id="tab-audit" class="tab-pane hidden">
          <div class="flex flex-col md:flex-row md:items-center justify-between mb-6 gap-3">
            <div>
              ...
              <p class="text-xs text-slate-500 mt-0.5">Ghi nhận chi tiết mọi thay đổi giá nhập, giá bán và xuất dữ liệu</p>
            </div>
          </div>
        ...
        <section id="tab-settings" class="tab-pane hidden">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="bg-white p-5 rounded-xl border border-slate-200 shadow-sm space-y-4 text-xs">
              <h3 class="font-bold text-slate-800 uppercase tracking-wider border-b border-slate-100 pb-2">Sao Lưu Dữ Liệu</h3>
              ...
              <div class="flex flex-wrap gap-2">
                ...
                <button onclick="openSystemResetConfirm()" class="px-3.5 py-2 bg-rose-50 text-rose-700 border border-rose-200 hover:bg-rose-100 rounded-lg font-bold flex items-center gap-1.5">
                  <i data-lucide="refresh-cw" class="w-3.5 h-3.5"></i> Khôi Phục Dữ Liệu 69 Model
                </button>
              </div>
            </div>
          </div>
  ...
  <!-- JAVASCRIPT -->
  <script>
    const STORAGE_KEY = 'LOCK_KING_PMS_DATA_v4_FINAL';
        ...
        auditLogs: [
          {
            ...
            userName: 'Admin',
            action: 'UPDATE_IMPORT_PRICES',
            entityType: 'CATALOG',
            details: 'Cập nhật thành công Giá Nhập Cũ vs Giá Nhập Mới và Thông Số Kỹ Thuật cho 69 Model',
            oldVal: 'Bản giá nhập trước',
            newVal: '20 model tăng, 17 model giảm giá nhập'
          }
        ]
      };
    }
    ...
    function renderDashboard() {
      ...
      if (!canViewImport) {
        container.innerHTML = '<div class="p-4 text-center text-xs text-slate-400">Bạn không có quyền xem thông tin giá nhập vốn.</div>';
        return;
      }
    ...
    function renderPriceChart(code) {
      ...
      const labels = canViewImport 
        ? ['Giá Nhập Cũ', 'Giá Nhập Mới', 'Giá NPP Online', 'Giá NPP Offline', 'Giá Facebook']
        : ['Giá NPP Online', 'Giá NPP Offline', 'Giá Facebook'];

      const data = canViewImport
        ? [p.oldImportPrice, p.newImportPrice, p.nppOnlinePrice, p.nppOfflinePrice, p.facebookPrice]
        : [p.nppOnlinePrice, p.nppOfflinePrice, p.facebookPrice];

      const colors = canViewImport
        ? ['#94a3b8', '#e11d48', '#6366f1', '#ea580c', '#0284c7']
        : ['#6366f1', '#ea580c', '#0284c7'];
      ...
      priceTrendChartInstance = new Chart(ctx, {
        ...
        data: {
          labels,
          datasets: [{
            label: \`So sánh giá Model: \${p.canonicalCode} (\${p.brand})\`,
            data,
      ...
      tbody.innerHTML = filtered.map(p => {
        ...
        return \`
          <tr class="hover:bg-slate-50/80 transition">
            ...
            <td class="py-2 px-3 text-right font-mono text-slate-400 col-import-price" style="display: \${canViewImport ? '' : 'none'}">
            ...
            <td class="py-2 px-3 text-center col-import-price" style="display: \${canViewImport ? '' : 'none'}">
              \${diffBadge}
            </td>

            <td class="py-2 px-3 text-right font-mono font-bold text-indigo-700">\${formatVND(p.nppOnlinePrice)}</td>
            <td class="py-2 px-3 text-right font-mono font-bold text-orange-700">\${formatVND(p.nppOfflinePrice)}</td>
    ...
    function viewProductSpecs(code) {
      ...
      document.getElementById('specsModalContent').innerHTML = \`
        <div class="space-y-2">
          <div class="font-bold text-slate-900 text-sm mb-1">\${p.name} (\${p.brand})</div>
          <div class="text-slate-600 whitespace-pre-line">\${escapeHtml(p.specs || 'Đang cập nhật thông số chi tiết từ nhà máy')}</div>
        </div>
      \`;
    ...
    function processStaging(fileName, rawRows) {
      ...
      let priceIdx = header.findIndex(h => h.includes('GIÁ NHẬP MỚI') || h.includes('GIÁ NPP') || h.includes('GIÁ MỚI'));
      ...
      dataRows.forEach((row, i) => {
        ...
        if (!target) {
          status = 'ERROR';
          issues.push(\`Model "\${identified}" chưa tồn tại trong danh mục\`);
        }
        ...
        let oldPrice = target ? target.newImportPrice : 0;
        let diffPct = 0;
    ...
    function commitImportData() {
      ...
      tempStagingData.rows.forEach(r => {
        ...
        if (p) {
          p.oldImportPrice = p.newImportPrice;
          p.newImportPrice = r.newPrice;
          p.importPrice = r.newPrice;
          p.importPriceDiff = p.newImportPrice - p.oldImportPrice;
          p.importPriceDiffPct = p.oldImportPrice > 0 ? (((p.importPriceDiff) / p.oldImportPrice) * 100).toFixed(2) : '0';
    ...
    function renderQuotationTable() {
      ...
      if (db.quotations.length === 0) {
        tbody.innerHTML = '<tr><td colspan="6" class="py-8 text-center text-slate-400">Chưa có báo giá nào được lưu. Nhấn "+ Lập Báo Giá Mới"</td></tr>';
        return;
      }
    ...
    function openSystemResetConfirm() {
      if (confirm("Khôi phục toàn bộ danh mục 69 sản phẩm gốc kèm Giá Nhập Cũ/Mới?")) {
        const init = getInitialData();
        saveDB(init);
...
console.log('index.html v4 compiled successfully!');
